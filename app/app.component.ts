...
export class AppComponent {
  ...
  // Binding to Primitive Local Data, AKA array of strings. YUH
  ...
  // We also have docs for binding to observables with the async pipe, hooking in a service, or connecting to streaming Data 👇
  //telerik.com/kendo-angular-ui-develop/components/dropdowns/autocomplete/data-binding/#toc-binding-to-remote-data
